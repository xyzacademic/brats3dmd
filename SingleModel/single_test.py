...
data_path = '../source_data/test_data_norm'
...
test_list = pd.read_csv('statistic/survival_evaluation.csv')['BraTS19ID'].values
...
model.inference(test_loader=test_loader, prob=False, target_path=args.comment.replace('train', 'test'), replace_origin='_t1', replace_target='')
