...
class SCD(object):
    ...
    def __init__(self, nrows, nfeatures, w_inc=100, tol=0.001, local_iter=10,
        ...
        self.w_inc = w_inc * np.array([1, 10, 1e2, 1e3,
                                       -1, -10, -1e2, -1e3, ],
                                      dtype=np.float32)
        self.w_index = []
        self.n_jobs = n_jobs
    ...
    def train(self, train_data, train_labels):
        ...
        for r in range(self.round):
            ...
            args=(train_data[:, column_indices], train_labels, plus, minus)))
    ...
    def single_run(self, data, labels, plus, minus):
        ...
        temp_w = np.random.uniform(-1, 1, size=(data.shape[1], )).astype(np.float32)
        for i in range(self.num_iters):
            ...
            temp_w, temp_b = self.single_iteration(temp_w, data[row_index],
                                                labels[row_index], plus, minus)
    ...
    def get_best_w_and_b(self, iter, data, labels, w, plus, minus,
        ...
        best_acc, b, best_index = self.get_best_b(labels, projection, None,
                                      raw_index_sorted, None, plus, minus)
        ...
        while best_acc - best_objective > self.tol and localit < self.local_iter:
            ...
            for update_index in updation_order:
                ...
                for w_inc in self.w_inc:
                    ...
                    labels, projection_new, best_index, raw_index_sorted_new,
...
if __name__ == '__main__':
    ...
    scd = SCD(nrows=0.2, nfeatures=0.6, w_inc=10, tol=0.001, num_iters=100,
